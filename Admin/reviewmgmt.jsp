...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h1 style="font-size:40px;color:teal;text-shadow:3px 3px 3px red;text-align:center">REVIEWMGMT</h1>
                ...
                <div class="col-sm-6">
                    <table border="5" width="100%" style="margin-top: 30px;">
                        ...
                        <tr style="background: #a1a1a1;color:#2e3f61;font-size: 18px;text-align:center;">
                            ...
                            <td><a href="../codes/deletereview.jsp?d=<%=rs.getString(3)%>"><span class="fa fa-trash" 
